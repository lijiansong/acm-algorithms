/*
    Description: woj1097-simple
    1个圆的面积：pi 
    2个圆交叉的面积：4/3*pi+sqrt(3)/2=5.05 
    3个圆交叉的面积：19/12*pi+1+sqrt(3)/2=6.84
    4个圆交叉的面积：5/3*pi+1+sqrt(3)=7.97
    半月形面积：pi/3+sqrt(3)/2=1.91
坑爹，这题1分，卡了我好久，看了别人的博客，贴的代码，其实这题不是那么简单
http://blog.csdn.net/stormdpzh/article/details/8760275
*/
